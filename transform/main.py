...
def main(filename):
    ...
    df = _remove_break_lines_from_body(df)
...
def  _remove_break_lines_from_body(df):
    logger.info('Remove break lines from body')
...
def _save_data(df, filename):
    clean_filename = 'clean_{}'.format(filename.replace('/', '_'))
